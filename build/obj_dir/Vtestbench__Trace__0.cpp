...
void Vtestbench___024root__trace_chg_0_sub_0(Vtestbench___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(((vlSelfRef.__Vm_traceActivity[3U] 
                      | vlSelfRef.__Vm_traceActivity
                      [4U])))) {
        bufp->chgIData(oldp+38,(vlSelfRef.testbench__DOT__sig),32);
        bufp->chgCData(oldp+39,((0x1fU & (((IData)(0x1fU) 
                                          ...
                                          - (IData)(9U)))),5);
        bufp->chgCData(oldp+40,((0x1fU & ((IData)(1U) 
                                          + (((IData)(0x1fU) 
                                              - ((IData)(vlSelfRef.testbench__DOT__l1__DOT__lzd__DOT__valid3__BRA__2__KET__)
                                                  ? (IData)(vlSelfRef.testbench__DOT__l1__DOT__lzd__DOT____VdfgRegularize_h740e574e_0_26)
                                                  : (IData)(vlSelfRef.testbench__DOT__l1__DOT__lzd__DOT____VdfgRegularize_h740e574e_0_28))) 
                                             - (IData)(9U))))),5);
        bufp->chgCData(oldp+41,(((((IData)(vlSelfRef.testbench__DOT__l1__DOT__lzd__DOT__valid2__BRA__5__KET__) 
        ...
        bufp->chgCData(oldp+43,((((IData)(vlSelfRef.testbench__DOT__l1__DOT__lzd__DOT__valid3__BRA__2__KET__) 
        ...
        bufp->chgCData(oldp+44,(vlSelfRef.testbench__DOT__l1__DOT__lzd__DOT__pos4[0]),5);
        bufp->chgCData(oldp+45,(vlSelfRef.testbench__DOT__l1__DOT__lzd__DOT__pos4[1]),5);
        bufp->chgCData(oldp+46,(((IData)(vlSelfRef.testbench__DOT__l1__DOT__lzd__DOT__valid3__BRA__2__KET__)
                                  ? (IData)(vlSelfRef.testbench__DOT__l1__DOT__lzd__DOT____VdfgRegularize_h740e574e_0_26)
                                  : (IData)(vlSelfRef.testbench__DOT__l1__DOT__lzd__DOT____VdfgRegularize_h740e574e_0_28))),5);
    }
    bufp->chgSData(oldp+47,(((IData)(((0x7f800000U 
                                       == (0x7f800000U 
                                           & vlSelfRef.testbench__DOT__fp)) 
                                      & (0U != (0x7fffffU 
                                                & vlSelfRef.testbench__DOT__fp))))
                              ? 0x1ffU : ((IData)((0x7f800000U 
                                                   == 
                                                   (0x7fffffffU 
                                                    & vlSelfRef.testbench__DOT__fp)))
                                           ? 0x1bfU
